(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('vue'), require('@temir/core'), require('vue/server-renderer'), require('@vue/runtime-core'), require('figures'), require('os'), require('path'), require('fs'), require('stream'), require('axios'), require('node:child_process'), require('node:util'), require('commander'), require('child_process')) :
  typeof define === 'function' && define.amd ? define(['vue', '@temir/core', 'vue/server-renderer', '@vue/runtime-core', 'figures', 'os', 'path', 'fs', 'stream', 'axios', 'node:child_process', 'node:util', 'commander', 'child_process'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vue, global.core, global.serverRenderer, global.runtimeCore, global.figures, global.os, global.path, global.fs, global.stream, global.axios, global.child_process, global.node_util, global.commander, global.child_process$1));
})(this, (function (vue, core, serverRenderer, runtimeCore, figures, os, path, fs, stream, axios, child_process, node_util, commander, child_process$1) { 'use strict';
  ...
  const stream__namespace = /*#__PURE__*/_interopNamespaceDefault(stream);
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _push, _parent, _attrs) => {
        _push(serverRenderer.ssrRenderComponent(vue.unref(core.TBox), _attrs, {
          default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), {
                color: vue.unref(props).isSelected ? "blue" : void 0
              }, {
                default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${serverRenderer.ssrInterpolate(vue.unref(props).label)}`);
                  } else {
                    return [
                      vue.createTextVNode(vue.toDisplayString(vue.unref(props).label), 1)
                    ];
                  }
                }),
                _: 1
              ...
              return [
                vue.createVNode(vue.unref(core.TText), {
                  color: vue.unref(props).isSelected ? "blue" : void 0
                }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(vue.unref(props).label), 1)
  ...
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      let props = __props;
      return (_ctx, _push, _parent, _attrs) => {
        _push(serverRenderer.ssrRenderComponent(vue.unref(core.TBox), vue.mergeProps({ marginRight: 1 }, _attrs), {
          default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (vue.unref(props).isSelected) {
                _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), { color: "blue" }, {
                  default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${serverRenderer.ssrInterpolate(vue.unref(figures).pointer)}`);
                    } else {
                      return [
                        vue.createTextVNode(vue.toDisplayString(vue.unref(figures).pointer), 1)
                      ];
                    }
                  }),
                  _: 1
                ...
                _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), null, {
                  default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${serverRenderer.ssrInterpolate(" ")}`);
                    } else {
                      return [
              ...
              return [
                vue.unref(props).isSelected ? (vue.openBlock(), vue.createBlock(vue.unref(core.TText), {
                  key: 0,
                  color: "blue"
                }, {
                  default: vue.withCtx(() => [
                  ...
                  _: 1
                })) : (vue.openBlock(), vue.createBlock(vue.unref(core.TText), { key: 1 }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(" "))
                  ]),
                  _: 1
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      core.useInput(onHandle);
      const mapped = runtimeCore.computed(() => props.items.reduce((acc, el, i) => [
        ...acc,
        { id: i, label: el.label, value: el.value }
      ], []));
      const highlight = runtimeCore.ref(0);
      const offset = runtimeCore.ref(props.value);
      ...
      const frame = runtimeCore.computed(() => {
        if (!props.frame_size)
          return mapped.value;
        return circularSlice(mapped.value, offset.value);
      });
      const selected = runtimeCore.computed(() => {
        return wrapNormalize(offset.value + highlight.value, mapped.value.length);
      });
      let atStart = runtimeCore.computed(() => selected.value === 0);
      let atEnd = runtimeCore.computed(() => selected.value === mapped.value.length - 1);
      const emit = __emit;
      return (_ctx, _push, _parent, _attrs) => {
        _push(serverRenderer.ssrRenderComponent(vue.unref(core.TBox), vue.mergeProps({ flexDirection: "column" }, _attrs), {
          default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (props.frame_size) {
                _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), null, {
                  default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${serverRenderer.ssrInterpolate(vue.unref(atStart) && !props.wrap ? " " : vue.unref(figures).triangleUp)}`);
                    } else {
                      return [
                        vue.createTextVNode(vue.toDisplayString(vue.unref(atStart) && !props.wrap ? " " : vue.unref(figures).triangleUp), 1)
                      ];
                    }
                  }),
                  _: 1
              ...
              _push2(`<!--[-->`);
              serverRenderer.ssrRenderList(vue.unref(frame), (item) => {
                _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TBox), null, {
                  default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      serverRenderer.ssrRenderVNode(_push3, vue.createVNode(vue.resolveDynamicComponent(props.indicatorComponent), {
                        isSelected: item.id == vue.unref(selected)
                      }, null), _parent3, _scopeId2);
                      serverRenderer.ssrRenderVNode(_push3, vue.createVNode(vue.resolveDynamicComponent(props.itemComponent), {
                        isSelected: item.id == vue.unref(selected),
                        label: "" + item.label
                      }, null), _parent3, _scopeId2);
                    } else {
                      return [
                        (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(props.indicatorComponent), {
                          isSelected: item.id == vue.unref(selected)
                        }, null, 8, ["isSelected"])),
                        (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(props.itemComponent), {
                          isSelected: item.id == vue.unref(selected),
                          label: "" + item.label
              ...
              _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), null, {
                default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${serverRenderer.ssrInterpolate(!props.frame_size || !props.wrap && vue.unref(atEnd) ? " " : vue.unref(figures).triangleDown)}`);
                  } else {
                    return [
                      vue.createTextVNode(vue.toDisplayString(!props.frame_size || !props.wrap && vue.unref(atEnd) ? " " : vue.unref(figures).triangleDown), 1)
                    ];
                  }
                }),
                _: 1
              }, _parent2, _scopeId));
              _push2(serverRenderer.ssrRenderComponent(vue.unref(core.TText), { color: "green" }, {
                default: vue.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${serverRenderer.ssrInterpolate(vue.unref(selected) + 1)}/${serverRenderer.ssrInterpolate(vue.unref(mapped).length)}`);
                  } else {
                    return [
                      vue.createTextVNode(vue.toDisplayString(vue.unref(selected) + 1) + "/" + vue.toDisplayString(vue.unref(mapped).length), 1)
                    ];
                  }
                }),
                _: 1
              ...
              return [
                props.frame_size ? (vue.openBlock(), vue.createBlock(vue.unref(core.TText), { key: 0 }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(vue.unref(atStart) && !props.wrap ? " " : vue.unref(figures).triangleUp), 1)
                  ]),
                  _: 1
                })) : vue.createCommentVNode("", true),
                (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(vue.unref(frame), (item) => {
                  return vue.openBlock(), vue.createBlock(vue.unref(core.TBox), null, {
                    default: vue.withCtx(() => [
                      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(props.indicatorComponent), {
                        isSelected: item.id == vue.unref(selected)
                      }, null, 8, ["isSelected"])),
                ...
                vue.createVNode(vue.unref(core.TText), null, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(!props.frame_size || !props.wrap && vue.unref(atEnd) ? " " : vue.unref(figures).triangleDown), 1)
                  ]),
                  _: 1
                }),
                vue.createVNode(vue.unref(core.TText), { color: "green" }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(vue.unref(selected) + 1) + "/" + vue.toDisplayString(vue.unref(mapped).length), 1)
                  ]),
                  _: 1
  ...
  const execPromise = node_util.promisify(child_process.exec);
  const finished = node_util.promisify(stream__namespace.finished);
  ...
  function editPath(cb) {
    ...
    if (osType === 'win32') {
      // Get User PATH
      let userPath = child_process.execSync(`[Environment]::GetEnvironmentVariable("Path", [EnvironmentVariableTarget]::User)`, {
      ...
      child_process.execSync(`[Environment]::SetEnvironmentVariable("PATH", "${newPATH}", [EnvironmentVariableTarget]::User)`, {
        shell: "powershell.exe"
      });
    } else {
  ...
  let stdb_path = path.join(os.homedir(), 'SpacetimeDB');
  ...
  program.command('current').description('Show active SpacetimeDB version and path.').action(noRender(async () => {
    ...
    console.log(child_process$1.execSync('where spacetime').toString()); // powershell only (otherwise can use 'where')
  ...
  let renderWait = (component, cb) => {
    ...
    r = core.render(component(resolvableCB));
  ...
  program.command('set').description('Set active SpacetimeDB version by tag name. (Has selector for no args)').option('<version>', 'Specific version to set.').option('-d, --direct', 'Use direct path to SpacetimeDB Version rather than replacing default.').option('-r, --remote', 'Set version from remote release list.').action(async (options, cmd) => {
    ...
    if (!version) {
      ...
      await renderWait(cb => vue.createVNode(_sfc_main, {
        "items": versionArr,
        "onSubmit": cb,
        "wrap": true
      }, null), exit => selected => {
    ...
    let current_path;
    try {
      let res_path = child_process$1.execSync('where spacetime').toString().split('\n')?.[0]; // can match multiple
  ...
  program.command('load').description('Download SpacetimeDB version. (Has selector for no args)').option('<version>', 'Download specific version.').action(async (_, cmd) => {
    ...
    let r = core.render(vue.createVNode(_sfc_main, {
